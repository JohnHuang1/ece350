...
#create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {CLK100MHZ}];
 set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { CLK10MHZ }]; #IO_L12P_T1_MRCC_35 Sch=clk10mhz
 create_clock -add -name sys_clk_pin -period 100.00 -waveform {0 50} [get_ports {CLK10MHZ}];
